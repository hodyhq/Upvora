...
export const bandForScore = (score: number): BandInfo => {
  ...
  if (score >= t.scorecardBandStrong)
    return {
      label: t.scorecardBandStrongLabel || "Strong Candidate",
      key: "strong",
      threshold: t.scorecardBandStrong,
      bg: "#DCFCE7",
      fg: "#14532D",
      border: "#16A34A",
    }
  if (score >= t.scorecardBandGood)
    return { label: t.scorecardBandGoodLabel || "Good Candidate", key: "good", threshold: t.scorecardBandGood, bg: "#DBEAFE", fg: "#1E3A8A", border: "#2563EB" }
  if (score >= t.scorecardBandRefine)
    return {
      label: t.scorecardBandRefineLabel || "Needs Refinement",
      key: "refine",
      threshold: t.scorecardBandRefine,
      bg: "#FEF3C7",
      fg: "#78350F",
      border: "#F59E0B",
    }
  if (score >= t.scorecardBandLow)
    return { label: t.scorecardBandLowLabel || "Low Priority", key: "low", threshold: t.scorecardBandLow, bg: "#FFEDD5", fg: "#7C2D12", border: "#F97316" }
  return { label: t.scorecardBandNoneLabel || "Not Recommended", key: "reject", threshold: 0, bg: "#FEE2E2", fg: "#7F1D1D", border: "#DC2626" }
}
