...
-- Seed the 6 built-in statuses for every seeded tenant. The migration inserts
-- these at migrate time, but this file TRUNCATE-CASCADEs tenants above, so we
-- re-seed here to match runtime state.
